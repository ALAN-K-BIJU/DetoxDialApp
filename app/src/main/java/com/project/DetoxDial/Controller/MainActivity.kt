...
import com.project.DetoxDial.databinding.ActivityMainBinding
...
import com.project.DetoxDial.Models.notification_services.InstalledAppsActivity
...
open class MainActivity : AppCompatActivity() {
   ...
   /** function to request a permission if it not granted */
    ...
    /**
     * S e l e c t_s m s_a p p_r e s u l t
     * This method retrieves the results from another activity (onActivityResult)
     */
    ...
    private fun addTime() {
        binding.textViewFreeAddTime.setOnClickListener {
            ...
            TimePickerDialog(
                this, R.style.Theme_Holo_Light_Dialog,
                timeListen,
